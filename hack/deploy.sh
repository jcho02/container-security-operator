...
# `quay.io/projectquay/container-security-operator-index:v1.0.6`. you can override the
...
#  - bundle/cso.operator-group.yaml
#  - bundle/cso.subscription.yaml
...
yq e -i '
	...
	.spec.name = "container-security-operator" |
